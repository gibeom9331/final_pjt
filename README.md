...
<div>
<h3>강이삭</h3>
<p> 이렇게 많은 시간과 노력을 들인 프로젝트는 처음이었기에 하고 싶은것도 해야하는 것도 많은 프로젝트였습니다. 시간이 부족하여 하고 싶은걸 다 하지는 못했지만 좋은 팀원들과 협업하여 휼륭한 결과물을 낸것에 만족합니다. 이렇게 프로젝트의 끝이 왔지만 이번 기회를 통해 배운 협업방식, 기술, 기획 등의 능력은 앞으로도 많은 도움이 될 것 같습니다.<br>
프로젝트를 진행하서 여러가지 에러(백엔드와 프론트엔트연동, 클라이언트쪽에서 모든 기능들을 수행하면 렉이 걸리는 현상 등)를 만나고 해결하면서 기술적으로 발전을 많이했고 예전에는 이론적인 부분을 모른채로 기계적으로 코딩을 했다면 이제는 코딩을 할 때 어떤식으로 동작하고 왜 이런식으로 코딩을 했는지 스스로 이해를 할 수 있게 됐습니다.<br>
또한, 인프라쪽 지식도 많이 늘었습니다. CI/CD를 구성하고 백엔드와 프론트엔드 서버를 구축하고 nginx로 배포하면서 대강알고 있던 포트라는 개념에 대해 정확히 알 수 있는 계기가 되었습니다.<br>
마지막으로 아쉬운 점이 있다면 rag의 정확도를 올리기 위해서는 데이터의 전처리과정이 중요하다는것을 늦게 깨달아 정확도가 안나온점이 아쉽고 유사문서를 찾을 때에도 엔지니어링을 잘 해야한다는 것을 모르고 있었다는게 너무 아쉬웠습니다. 그리고 보안에 관련해서도 한번 공부해보고 적용을 시키고 싶었는데 기간이 2달인지라 해보지 못한게 너무 큰 아쉬움으로 남습니다.
</p>
<br>
